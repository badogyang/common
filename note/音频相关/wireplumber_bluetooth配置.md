[Bluetooth configuration — WirePlumber 0.5.5 documentation (pages.freedesktop.org)](https://pipewire.pages.freedesktop.org/wireplumber/daemon/configuration/bluetooth.html#)



我这边是用的RK3568主控，配置文件在/usr/share/wireplumber/bluetooth.lua.d/50-bluez-config.lua路径
